        ...
        >
          ...
          >
            <Fade>
              ...
              <p className={timeLineStyle.endDate}>
                {index === timeLines.length - 1
                  ? "Present"
                  : getDateFormated(timeline.endDate)}
              </p>
            </Fade>
          </div>
        </li>
  ...
  return (
    <div className="wrapper-box">
      ...
      {window.innerWidth < 700 && (
        <div className={timeLineStyle.buttonWrapper}>
          <button
            onClick={() => {
              updateTimelineState(
                timelineState === timeLines.length ? 0 : timelineState + 1
              );
